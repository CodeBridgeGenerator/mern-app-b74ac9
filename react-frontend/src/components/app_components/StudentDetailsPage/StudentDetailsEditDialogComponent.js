...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="DOB" value={_entity?.DOB ? new Date(_entity?.DOB) : null} onChange={ (e) => setValByKey("DOB", new Date(e.target.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
            {!_.isEmpty(error["DOB"]) && (
