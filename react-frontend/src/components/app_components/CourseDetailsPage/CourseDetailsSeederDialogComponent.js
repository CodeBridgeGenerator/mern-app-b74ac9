...
import seederData from "./courseDetails.seeder.json";
...
const CourseDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CourseDetailsSeederDialogComponent);
