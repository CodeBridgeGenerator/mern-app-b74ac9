...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.stuId}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.stuName}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.NIC}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.course}</p>
const p_calendarTemplate4 = (rowData, { rowIndex }) => <p >{rowData.DOB}</p>
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.address}</p>
...
<Column field="stuId" header="StuId" body={pTemplate0} filter={selectedFilterFields.includes("stuId")} hidden={selectedHideFields?.includes("stuId")}  sortable style={{ minWidth: "8rem" }} />
<Column field="stuName" header="StuName" body={pTemplate1} filter={selectedFilterFields.includes("stuName")} hidden={selectedHideFields?.includes("stuName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="NIC" header="NIC" body={pTemplate2} filter={selectedFilterFields.includes("NIC")} hidden={selectedHideFields?.includes("NIC")}  sortable style={{ minWidth: "8rem" }} />
<Column field="course" header="Course" body={pTemplate3} filter={selectedFilterFields.includes("course")} hidden={selectedHideFields?.includes("course")}  sortable style={{ minWidth: "8rem" }} />
<Column field="DOB" header="DOB" body={p_calendarTemplate4} filter={selectedFilterFields.includes("DOB")} hidden={selectedHideFields?.includes("DOB")}  sortable style={{ minWidth: "8rem" }} />
<Column field="address" header="Address" body={pTemplate5} filter={selectedFilterFields.includes("address")} hidden={selectedHideFields?.includes("address")}  sortable style={{ minWidth: "8rem" }} />
