...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">NIC</label><p className="m-0 ml-3" >{_entity?.NIC}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Course</label><p className="m-0 ml-3" >{_entity?.course}</p></div>
